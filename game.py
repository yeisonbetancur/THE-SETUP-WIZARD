...
class OptionsState(State):
    def enter(self):
        ...
        # Botón volver
        self.btn_volver = Button(cx - 100, 450, 200, 50, "VOLVER", self.game.fuente_chica)
    ...
    def handle_events(self, eventos):
        for e in eventos:
            ...
            if self.selector_res.handle_event(e):
                ...
                self.enter()  # Recrear UI con nueva resolución
...
class PlayingState(State):
    ...
    def draw(self, pantalla):
        ...
        pygame.draw.circle(pantalla, (255, 200, 0), self.pos, 20)
        texto = self.game.fuente_chica.render("WASD mover | ESC pausa", True, (255, 255, 255))
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("EL jogo")
